...
$pass = clear(sha1($_POST['password']));


$select = mysqli_query($conn, " SELECT * FROM `user_form` WHERE email = '$email' AND password = '$pass'") or die('query failed_1');
...
$message[] = 'المستخدم موجود بالفعل!';
    ...
    mysqli_query($conn, "INSERT INTO `user_form`(name,email,password) VALUES ('$name' , '$email' , '$pass') ") or die ('query failed_2');
...
<form action="" method="post">
      ...
      <span class="subtitle">مرحبا بك في موقع جدولكم لى انشاء الجدول وجعل حياتك سهلة</span>
      <br>
      <br>

      <div class="input_container">
    <label class="input_label" for="email_field">الاسم</label>
    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
      <path stroke-linejoin="round" stroke-linecap="round" stroke-width="1.5" stroke="#141B34" d="M7 8.5L9.94202 10.2394C11.6572 11.2535 12.3428 11.2535 14.058 10.2394L17 8.5"></path>
    </svg>
    <input placeholder="الاسم" title="Inpit title" name="name"  type="text" class="input_field" id="email_field">
  </div>

  <div class="input_container">
    <label class="input_label" for="email_field">بريد إلكتروني</label>
    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
      <path stroke-linejoin="round" stroke-linecap="round" stroke-width="1.5" stroke="#141B34" d="M7 8.5L9.94202 10.2394C11.6572 11.2535 12.3428 11.2535 14.058 10.2394L17 8.5"></path>
  ...
  <div class="input_container">
    <label class="input_label" for="password_field">كلمة المرور</label>
    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
