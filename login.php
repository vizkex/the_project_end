...
<meta charset="UTF-8">
    ...
    <title>جدولكم | تسجيل الدخول</title>
</head>
<body>
...
<form action="" method="post">
  ...
  <div class="input_container">
    ...
    <input placeholder="name@mail.com" title="Inpit title" name="email" name="email" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" maxlength="30" title="Inpit title" name="password" type="password" class="input_field" id="password_field">
  </div>
  <br>
    ...
    <hr class="line">
      ...
      <p>ليس لديك حساب ؟<a href="register.php"> انشاء حساب</a></p>
</form>
</div>
